const KannasoTrack = require('./KannasoTrack.js');
...
class KannasoTrackList {
    ...
    constructor(raw) {
         ...
         * @type {Array<KannasoTrack>}
         */
        this.tracks = raw.tracks.length ? raw.tracks.map(d => new KannasoTrack(d)) : [];
    }
}

module.exports = KannasoTrackList;
